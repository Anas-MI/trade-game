...
const url = `https://relentless.doitsindia.com/api/TG_user_buy_random_share/?user_id=${userId}&symbol=${this.state.symbol.toUpperCase()}&share_unit=${unit}&date=${dateToSend}&pre_close_price=1.2226&curr_close_price=${selectedData.data[2]}`
